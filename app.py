...
def download_nltk_data():
    ...
    # Removed nltk.download('punkt_tab') as it's not strictly necessary for word_tokenize
    # and was causing a LookupError. 'punkt' is sufficient for general word tokenization.
